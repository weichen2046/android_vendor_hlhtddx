...
include vendor/hlhtddx/build/core/pathmap.mk
include vendor/hlhtddx/build/core/qcom_utils.mk
...
dump-qcom-vars:
	@echo 'BOARD_USES_QCOM_HARDWARE=$(BOARD_USES_QCOM_HARDWARE)'
	@echo 'TARGET_USES_QCOM_BSP=$(TARGET_USES_QCOM_BSP)'
	@echo 'TARGET_BOARD_PLATFORM=$(TARGET_BOARD_PLATFORM)'
	@echo 'BOARD_USES_ADRENO=$(BOARD_USES_ADRENO)'
	@echo 'QCOM_BOARD_PLATFORMS=$(QCOM_BOARD_PLATFORMS)'
	@echo 'pathmap_PROJ=$(pathmap_PROJ)'
	@echo 'qcom-display=$(call project-path-for,qcom-display)'
	@echo 'qcom-media=$(call project-path-for,qcom-media)'
	@echo 'is-board-platform(msm8960)=$(call is-board-platform,msm8960)'
	@echo 'get-vendor-board-platforms(QCOM)=$(call get-vendor-board-platforms,QCOM)'
	@echo 'is-vendor-board-platform(QCOM)=$(call is-vendor-board-platform,QCOM)'
